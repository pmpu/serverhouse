...
## новые задачи
<a href="https://docs.google.com/document/d/1x4Olp60GagKTgpSLRdgsnVOH-qS7F-PeaJQaMJFIeVc/edit?usp=sharing">исходник</a>
...
<b>Задачи мастера текстур (art7)</b><br>
Вытрясти модель жесткого диска с грубыми текстуры, следуя видеотуториалу <a href="http://www.youtube.com/watch?v=zG2BpsgPFkc">тут</a> (5я часть)<br>
...
<b>Пара мастер текстур (art7) + мастер моделирования (art6) </b><br>
...
<b>Задачи отдела интеграции (art9)</b><br>
...
<b>Интегратор (art9) + UI программист(art2) + программист ответственный за коммуникации (code4)</b><br>
...
<b>Клиентский программист (code1)</b><br>
...
<b>Программист ответственный за коммуникации (code4)</b><br>
...
<b>Серверный программист (code3)</b><br>
...
<b>Универсальный программист Босс (code5)</b><br>
